#
# Me2c.icl - Common product components for ICL DRS-6000
#
...
CFLAGS=-DSCO -DPOSIX  -DV4 -DICL -g -I. -DAT
RANLIB = ar ts
VCC = cc
CC = cc
XPGCC = cc
...
comlib.a: datlib.o hashlib.o natmlib.o natregex.o e2compat.o e2file.o e2compat.o
	ar rv $@ $?
	$(RANLIB) $@
